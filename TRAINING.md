...
- **Terms:** Requires valid Planet API key and subscription
...
- **Access:** https://console.cloud.google.com/storage/browser/open-buildings-temporal-data/v1
- **Citation:** Sirko, W. et al. High-Resolution Building and Road Detection from Sentinel-2. arXiv:2310.11622 (2023).
- **Dataset Info:** https://sites.research.google/gr/open-buildings/temporal/
- **Earth Engine:** https://developers.google.com/earth-engine/datasets/catalog/GOOGLE_Research_open-buildings-temporal_v1

### External Data Sources

**Overture Maps Building Priors**
...
- **Usage:** Building footprint priors used as input features for model training
